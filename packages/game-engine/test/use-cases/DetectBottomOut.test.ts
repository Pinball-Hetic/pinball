...
import { DetectBottomOut } from '../../src/use-cases/DetectBottomOut';
import { BOTTOM_OUT_Z } from '../../src/domain/PlayfieldGeometry';
import { WALL_RIGHT_X } from '../../src/domain/Ball';
