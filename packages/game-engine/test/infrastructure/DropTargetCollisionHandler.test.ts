...
import { DropTargetCollisionHandler } from '../../src/infrastructure/DropTargetCollisionHandler';
import type { MapLayout, DropTargetDef } from '../../src/domain/MapLayout';
import type { GameEvent } from '../../src/domain/GameEvents';
import { SCORE_DROP_TARGET, SCORE_DROP_COMPLETE } from '../../src/domain/ScoringConstants';
