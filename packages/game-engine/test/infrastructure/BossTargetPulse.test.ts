...
import { BossTargetPulse, type BossTargetPulseParts } from '../../src/infrastructure/BossTargetPulse';
import type { BossTargetPulseConfig } from '../../src/domain/BossRegistry';
