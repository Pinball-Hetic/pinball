...
import { BlackoutFightPhaseMachine } from '../../src/infrastructure/BlackoutFightPhaseMachine';
import { easeOut, easeIn, strobeOn } from '../../src/infrastructure/CinematicEasing';
