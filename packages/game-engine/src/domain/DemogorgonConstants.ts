...
export const DEMOGORGON_ANIM_IDLE = 'IdleHunt';
export const DEMOGORGON_ANIM_HIT = 'Hit';
export const DEMOGORGON_ANIM_VICTORY = 'Fall';
export const DEMOGORGON_ANIM_VICTORY_FALLBACK = 'Destroy';
